...
// alter语句
struct alter_stmt : modifying_stmt
{
    alter_stmt(prod *p, struct scope *s, table *victim = 0);
    virtual void out(std::ostream &out);
    virtual void accept(prod_visitor *v)
    {
      v->visit(this);
...
// desc 语法
struct desc_stmt : modifying_stmt
{
    desc_stmt(prod *p, struct scope *s, table *victim = 0);
    virtual void out(std::ostream &out);
    virtual void accept(prod_visitor *v)
    {
      v->visit(this);
